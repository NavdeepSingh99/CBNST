...
interpolation value at 1934.000000  = 12.272310

*/

void newton_forward(float x[], float y[10][10], int n, float x_interpolation){
    ...
    float p = (x_interpolation - x[0]) / (x[1] - x[0]);
    float result = y[0][0];
...
int main(){
    ...
    newton_forward(x, y, n, x_interpolation);
    return 0;
}